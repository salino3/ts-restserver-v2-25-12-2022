...
exports.PrivateRouteWebMaster = void 0;
...
const PrivateRouteWebMaster = () => {
    const { isAuthenticated, webMaster } = (0, react_1.useContext)(GlobalContext_1.GlobalContext);
    if (!webMaster) {
...
exports.PrivateRouteWebMaster = PrivateRouteWebMaster;
//# sourceMappingURL=PrivateRouteWebMaster.js.map